function evenFibonacciNumbers(limit) {
  ...
  let array = new Array(100 + 1).fill(null);
  array[0] = 0;
  array[1] = 1;
  for (let i = 2; i <= 100; i++) {
...
$(function() {
  let description = 'Each new term in the Fibonacci sequence is generated by adding the previous two terms. By starting with 1 and 2, the first 10 terms will be:\n' +
    '\n' +
  ...
  $(id).find('button').click(function() {
    var result = evenFibonacciNumbers(4000000);
